 ...
 * @date 2021/1/25
 */
public class ZSetOps extends AbstractJedisOps {

    public Supplier<Boolean> add(String key, String value, double score) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().add(key, value, score));
    }

    public Supplier<Long> add(String key, Set<ZSetOperations.TypedTuple<String>> tuples) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().add(key, tuples));
    }

    public Supplier<Long> remove(String key, Object... values) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().remove(key, values));
    }
    ...
    public Supplier<Double> rank(String key, Object o) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().rank(key, o));
    }

    public Supplier<Long> reverseRank(String key, Object o) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().reverseRank(key, o));
    }

    public Supplier<Set<Long>> range(String key, long start, long end) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().range(key, start, end));
    }

    public Supplier<ZSetOperations.TypedTuple<String>> rangeWithScores(String key, long start, long end) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().rangeWithScores(key, start, end));
    }

    public Supplier<Set<String>> rangeByScore(String key, double min, double max) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().rangeByScore(key, min, max));
    }

    public Supplier<ZSetOperations.TypedTuple<String>> rangeByScoreWithScores(String key, double min, double max) {
        return this.jedisPipeline.addOperation(operations ->
    ...
    public Supplier<ZSetOperations.TypedTuple<String>>
    ...
    public Supplier<Set<String>> rangeByScore(String key, long start, long end) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().reverseRange(key, start, end));
    }

    public Supplier<ZSetOperations.TypedTuple<String>> reverseRangeWithScores(String key, long start, long end) {
        return this.jedisPipeline.addOperation(operations ->
    ...
    public Supplier<Long> count(String key, double min, double max) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().count(key, min, max));
    }

    public Supplier<Long> size(String key) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().size(key));
    }

    public Supplier<Long> zCard(String key) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().zCard(key));
    }

    public Supplier<Double> score(String key, Object o) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().score(key, o));
    }

    public Supplier<Long> removeRange(String key, long start, long end) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().removeRange(key, start, end));
    }
    ...
    public Supplier<Cursor<ZSetOperations.TypedTuple<String>>> scan(String key, ScanOptions options) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().scan(key, options));
    }

    public Supplier<Set<String>> rangeByLex(String key, RedisZSetCommands.Range range) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().rangeByLex(key, range));
    }

    public Supplier<Set<String>> rangeByLex(String key, RedisZSetCommands.Range range, RedisZSetCommands.Limit limit) {
        return this.jedisPipeline.addOperation(operations -> operations.opsForZSet().rangeByLex(key, range, limit));
    }

    ZSetOps(JedisPipeline jedisPipeline) {
        super(jedisPipeline);
    }
}
